...
describe('crud', () => {
  ...
  test('builds application registration', async () => {
    ...
    const agentRegistration = await factory.applicationRegistration(agentRegistrationUrl)
  ...
  test('builds social agent registration', async () => {
    ...
    const agentRegistration = await factory.socialAgentRegistration(agentRegistrationUrl)
    expect(agentRegistration).toHaveProperty('id', agentRegistrationUrl)
  ...
  test('authorizationRegistry', async () => {
    ...
    const authorizationRegistry = await factory.authorizationRegistry(snippetIri)
  ...
  test('agentRegistry', async () => {
    ...
    const agentRegistry = await factory.agentRegistry(snippetIri)
  ...
  test('dataRegistration with passed data', async () => {
    ...
    const dataRegistration = await factory.dataRegistration(snippetIri, data)
  ...
  test.skip('registrySet', async () => {
    ...
    const registrySet = await factory.registrySet(snippetIri)
...
describe('immutable', () => {
  describe('data grant', () => {
    ...
    test('builds AllFromRegistry data grant', async () => {
      ...
      const dataGrant = factory.dataGrant(dataGrantIri, allFromRegistryData)
    ...
    test('builds SelectedFromRegistry data grant', async () => {
      ...
      const dataGrant = factory.dataGrant(dataGrantIri, selectedFromRegistryData)
      expect(dataGrant).toHaveProperty('id', dataGrantIri)
    ...
    test('builds Inherited data grant', async () => {
      ...
      const dataGrant = factory.dataGrant(dataGrantIri, inheritnstancesData)
      expect(dataGrant).toHaveProperty('id', dataGrantIri)
...
describe('readable', () => {
  ...
  test('dataAuthorization', async () => {
    ...
    const dataAuthorization = await factory.dataAuthorization(snippetIri)
